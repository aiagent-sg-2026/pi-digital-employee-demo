...
describe("i18n registry",()=>{
  ...
  it("keeps dynamic issue wording idiomatic in Traditional Chinese",()=>{expect(tFor("zh-TW","issue.duplicatePayment.title")).toBe("檢測到重複付款導入");expect(tFor("zh-TW","issue.unmatchedPayment.detail",{amount:"SGD 2,750"})).toContain("銀行");expect(tFor("zh-TW","issue.ambiguousCustomer.detail",{count:2,customer:"Twin"})).toContain("確認");});
