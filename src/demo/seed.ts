...
export const demoSeedInbox: BusinessInboxItem[] = [
  {id:"inbox-unmatched-payment",issueKey:"unmatched-payment:payment-unmatched-001",messageKey:"issue.unmatchedPayment",messageParams:{amount:2750,currency:"SGD",payment:"BANK-UNMATCHED-001"},type:"unmatched-payment",severity:"warning",relatedEntityType:"payment",relatedEntityId:"payment-unmatched-001",createdAt:"2025-03-01T08:15:00Z",status:"open",title:"Unmatched payment requires investigation",detail:"SGD 2,750 bank receipt has no customer or invoice match.",seeded:true},
  {id:"inbox-duplicate-payment",issueKey:"duplicate-payment:payment-acme-101-duplicate",messageKey:"issue.duplicatePayment",messageParams:{payment:"PAY-ACME-101"},type:"duplicate-payment",severity:"info",relatedEntityType:"payment",relatedEntityId:"payment-acme-101-duplicate",createdAt:"2025-03-01T08:30:00Z",status:"open",title:"Duplicate payment import detected",detail:"PAY-ACME-101 appears twice in the import feed.",seeded:true},
  {id:"inbox-dispute",issueKey:"invoice-dispute:invoice-riverside-river-401",messageKey:"issue.invoiceDispute",messageParams:{customer:"Riverside",invoice:"INV-RIVER-401"},type:"invoice-dispute",severity:"warning",relatedEntityType:"invoice",relatedEntityId:"invoice-riverside-river-401",createdAt:"2025-03-01T08:40:00Z",status:"open",title:"Riverside invoice dispute",detail:"Customer disputes invoice INV-RIVER-401.",seeded:true},
  {id:"inbox-credit-limit",issueKey:"credit-limit:customer-brightstar",messageKey:"issue.creditLimit",messageParams:{customer:"Bright Star",limit:40000,currency:"SGD"},type:"credit-limit",severity:"critical",relatedEntityType:"customer",relatedEntityId:"customer-brightstar",createdAt:"2025-03-01T08:50:00Z",status:"open",title:"Bright Star credit exposure",detail:"Open exposure approaches the SGD 40,000 demo credit limit.",seeded:true},
  {id:"inbox-ambiguous",issueKey:"ambiguous-customer:twin",messageKey:"issue.ambiguousCustomer",messageParams:{customer:"Twin",count:2},type:"ambiguous-customer",severity:"warning",relatedEntityType:"customer",relatedEntityId:"customer-twin-north",createdAt:"2025-03-01T09:00:00Z",status:"open",title:"Twin identity is ambiguous",detail:"Two canonical Twin customers match the broad alias and require clarification.",seeded:true},
];
